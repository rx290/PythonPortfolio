...
from string import ascii_letters
with open("./File Handling/file_handling_basic/task15b.txt",'a') as f:
    for i in range(26,52):
        alphabetString = "Specified Number for Letter "+ascii_letters[i]+ " is "+str(i)+'\n'
        f.write(alphabetString)
