...
2. Difference between OOP and Structural Programming?
    ...
    <tr>
        <td>It generally follows “Top-Down Approach”.  </td>
        <td>It generally follows “Bottom-Up Approach”.  </td>
    </tr>
    <tr>
...
4. What is difference between encapsulation and abstraction?
...
10. Difference between abstract class and interface?
    ...
    <tr>
        ...
        <td>The interface can have only abstract methods.</td>
    </tr>
    <tr>
        <td>2</td>
        <td>It does not support multiple inheritances.</td>
        <td>It supports multiple inheritances.</td>
    </tr>
    <tr>
        <td>3</td>
        <td>It can provide the implementation of the interface.</td>
        <td>It can not provide the implementation of the abstract class.</td>
    </tr>
    <tr>
        <td>4</td>
        <td>An abstract class can have protected and abstract public methods.</td>
        <td>An interface can have only have public abstract methods.</td>
    </tr>
    <tr>
        <td>5</td>
        <td>An abstract class can have final, static, or static final variable with any access specifier.</td>
        <td>The interface can only have a public static final variable.</td>
    </tr>
    <tr>
        <td>6</td>
        <td>The objects that help to perform abstraction are encapsulated.</td>
...
11. What are access specifiers and why they're used?
...
12. How do we modify protected data?

    By using setter and getters

13. Why setters, getters are kept public but the data is kept private?
...
14. What are different types of argument?
...
19. What is difference between structure and a class?
...
21. How is overloading and overriding done?
...
22. What is the difference between OOP and SOP?
...
23. What is Data abstraction and its techniques?
...
25. What is Garbage Collection (GC)?
